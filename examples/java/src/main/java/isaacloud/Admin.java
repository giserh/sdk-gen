...
public class Admin extends Connector {
	...
	/**
	 * Access to url : /admin/functions/{id}. Add a function.
	 * 
	 * @param body
	...
	/**
	 * Access to url : /admin/transactiontypes/{id}/conditions/{childId}. Update
	 * a condition for transaction type.
	 * 
	 * @param body
	 *            application/json schema : {}
	 ...
	 *         { "$schema":"http://json-schema.org/draft-03/schema",
	 *         "description"
	 *         :"A representation of a list of achievement groups.", "type" :
	 *         "array", "items" :{ "type":"object", "required":false,
	 ...
	 * @return return value 400 : OR 404 : OR 500 : OR 200 : application/json :
	 *         { "$schema":"http://json-schema.org/draft-03/schema",
	 *         "description":"A representation of a segment", "type":"array",
	 *         "items":{ "type":"object", "required":false, "properties":{
	 *         "start":{ "required":false, "type":"integer" }, "stop":{
	 *         "required":false, "type":"integer" }, "achievement":{
	 ...
	 * @return return value 400 : OR 404 : OR 500 : OR 200 : application/json :
	 *         { "$schema":"http://json-schema.org/draft-03/schema",
	 *         "description":"A representation of a category", "type" : "array",
	 *         "items" :{ "type":"object", "required":false, "properties":{
	 *         "name":{ "required":false, "type":"integer" }, "members":{
	 *         "required":false, "type":"array", "items":{ "type":"integer" } }
	 *         } } }
	 * @param order
	 *            The fields we want to order by and the type of ordering.
	 * @param limit
	...
	/**
	 * Access to url : /admin/leaderboards/{id}. Add a leaderboard.
	 * 
	 * @param body
	 *            application/json schema : {}
	 * @return return value 400 : OR 404 : OR 500 : OR 200 :
	...
	/**
	 * Access to url : /admin/users/groups/{id}/users/{childId}. Delete a friend
	 * from user group.
	 * 
	 * @return return value 400 : OR 404 : OR 500 : OR 200 :
	 */
	...
	/**
	 * Access to url : /admin/users/groups/{id}/users/{childId}. Add a friend to
	 * user group.
	 * 
	 * @param body
	 *            application/json schema : {}
	 ...
	 * 
	 * @param fields
	 *            The fields we want to show in our result Get one client script
	 *            by id.
	 * @return return value 400 : OR 404 : OR 500 : OR 200 : application/json :
	 *         {}
	 */
